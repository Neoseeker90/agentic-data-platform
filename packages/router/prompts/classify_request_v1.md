...
- answer_business_question: ONLY for open-ended conceptual questions with no specific time period or breakdown that would require querying data — e.g. "Why did revenue drop?", "What factors drive churn?", "What should we focus on?". If the question asks "what was X" or "how much was X", use execute_data_question instead.
